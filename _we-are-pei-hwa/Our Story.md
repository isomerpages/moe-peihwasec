...
In 2014, Pei Hwa was one of the 12 pilot schools to implement Subject-Based Banding (SBB). The school’s Applied Learning Programme (ALP) is in Robotics and Programming, with a science, technology, engineering and mathematics focus. Its Learning for Life Programme (LLP) is in Community Youth Leadership, titled ‘PRIDE of the Community: Developing Altruists’. <br>
In 2018, the school integrated its ALP and LLP in a new Project Work curriculum. The school launched its inaugural Open House and also saw the completion of the indoor sports hall. <br>
