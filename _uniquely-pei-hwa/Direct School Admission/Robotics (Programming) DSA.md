...
permalink: /uniquely-pei-hwa/direct-school-admission/robotics-programming-dsa/
description: ""
...
<p style="margin-top:15.5px;font-size:15.5px;"><strong style="font-family:sans-serif;">Opportunity for International Competition</strong></p>
...
<tr>
				...
				<td style="font-family:sans-serif;margin-bottom:5px;">Application for DSA-Sec can be submitted through the online DSA-Sec Portal. The application is free-of-charge. For more information, please refer to MOE website – <a style="font-size:14.5px; line-height:1.5;font-family:sans-serif;font-weight:bold;text-decoration: none;" href="www.moe.gov.sg/dsa-sec">www.moe.gov.sg/dsa-sec</a></td>
