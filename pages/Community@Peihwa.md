...
background-image: url('https://raw.githubusercontent.com/isomerpages/moe-peihwasec/staging/images/bgfade2.png'); background-size: 120%; background-height:120%; background-repeat: no-repeat;" class="box"> 
